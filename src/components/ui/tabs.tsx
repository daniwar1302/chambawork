...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl bg-pink-50 p-1 text-pink-600",
      className
    )}
    {...props}
  />
